...
While older version of 'math', just by required, caused changes to the
behavior (and even the types) of operations on classes like Integer
newer `mathn` introduces the refinements `Math::N`, and you have to
enable it.
